    ...
    const getRestData = () => {
        ...
        axiosInstance
            ...
            .then((res) => {
                ...
                if (!(res.data.r_address_line && res.data.r_city && res.data.r_state && res.data.r_zipcode)) {
                ...
                res.data.r_delivery_type = res.data.r_delivery_type ? res.data.r_delivery_type : '';
                            ...
                            restDetails.dishes.map((ele) => (
                                <Col xs={3} key={index} style={{ marginTop: '30px' }}>
                                    ...
                                    <Card>
                                        <Card.Img
                                            variant="top"
                                            src={ele.dish_imgs.length > 0 ? ele.dish_imgs[0].di_img : ''}
                                            style={{ height: '300px' }}
                                        />
                                        <Card.Body>
