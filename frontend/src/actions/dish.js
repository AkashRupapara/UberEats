...
import { DISH_IMAGE_UPLOAD_FAILURE, DISH_IMAGE_UPLOAD_REQUEST, DISH_IMAGE_UPLOAD_SUCCESS } from "./types";
...
export function dishImageUploadSuccess(did, link) {
    return (dispatch) => {
        return axiosInstance.post(`/dishes/images/${did}`,{
            img: link,
          },{
            headers: {
...
export function dishImageUploadFailure(payload) {
    return {
        type: DISH_IMAGE_UPLOAD_FAILURE, payload
    };
}