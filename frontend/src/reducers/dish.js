import { DISH_IMAGE_DELETE_FAILURE, DISH_IMAGE_DELETE_REQUEST, DISH_IMAGE_DELETE_SUCCESS, DISH_IMAGE_UPLOAD_FAILURE, DISH_IMAGE_UPLOAD_REQUEST, DISH_IMAGE_UPLOAD_SUCCESS } from "../actions/types";
